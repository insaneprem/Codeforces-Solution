<h2><a href="https://codeforces.com/contest/2093/problem/F" target="_blank" rel="noopener noreferrer">2093F — Hackers and Neural Networks</a></h2>
...
| **Verdict** | ✅ Accepted |
| **Problem Link** | [Codeforces 2093F](https://codeforces.com/contest/2093/problem/F) |
...
b a k A
u s k J
</pre></div><div class="output"><div class="title">Output<div title="Copy" data-clipboard-target="#id0048434371329757553" id="id007421762929526953" class="input-output-copier">Copy</div></div><pre id="id0048434371329757553">5
-1
6
8
</pre></div></div></div>